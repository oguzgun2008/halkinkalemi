            ...
            <div class="col-md-12">
                <div class="widget">
                    <header class="widget-header">
                        <h4 class="widget-title">Kategori Düzenleme</h4>
                    </header><!-- .widget-header -->
                    <hr class="widget-separator">
                    <div class="widget-body">

                        <form class="form-horizontal" action="{{route('admin_category_update',$edit->id)}}" method="post">
                            @csrf
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select id="select2-demo-1" name="parent_id" class="form-control" data-plugin="select2">
                                        ...
                                        @foreach($datalist as $ana)
                                            <option value="{{$ana->id}}" @if($ana->id==$edit->parent_id) selected="selected" @endif>{{\App\Http\Controllers\Admin\CategoryController::getParentsTree($ana,$ana->title)}}</option>
                                        @endforeach
                                    </select>
                                </div><!-- END column -->
                            </div><!-- .form-group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="exampleTextInput1" name="detail" value="{{$edit->detail}}">
                                </div>
                            </div>
                            <div class="form-group">
